        ...
        message.guild.channels.create("Music Requests", {
            ...
            message.guild.channels.create(`🎧｜Music`, {
                ...
                message.guild.channels.create(`🎵｜Requests`, {
                    ...
                    topic: `To request a Track, simply Type the **SONG NAME** into the Channel or the **URL** and the Bot will play it! Make sure that you are in the **right** Voice Channel (🎧｜Thot ♪ Music)!`,
                    parent: channel1.id,
                    permissionOverwrites: [{
                        id: message.guild.id,
                    ...
                    let pehla = new MessageEmbed()
                        ...
                        .setTitle("Thot ♪ Music | Request | Guide")
                        .setDescription(`Enter the song name or URL to play a song\n\n For Example ${config.prefix}play \`Nasheed song\``)
                        .setFooter("@Thot ♪")
                    ...
                    let dusra = new MessageEmbed()
                        ...
                        .setThumbnail(client.user.displayAvatarURL())
                        .setAuthor(message.author.username)
                        .setTitle("Thot ♪ Music - Best Free Music Bot of 2021")
                        .setDescription(`Join a voice channel and enter a song name or url to play.`)
                        .setImage('https://cdn.discordapp.com/attachments/959499368988287086/959663801500839946/connecting.gif')
                        .setFooter("@Thot ♪")

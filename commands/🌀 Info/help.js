    ...
    run: async (client, message, args) => {
        ...
        if (!args[0]) {
            ...
            const embed = new MessageEmbed()
                .setTitle("<a:hydroxTrophy:959516700057931876> I Am Thot  ♪ Here Is My Information <a:w2:959516713769132032> ")
                .addField('Prefix Information', `Prefix: \`${config.prefix}\`\nYou can also mention ${client.user} to get prefix info.`, false)
                .addFields(categories)
                .setImage('https://share.creavite.co/3w4Q665XfYdCkI4P.gif')
                .setDescription(
